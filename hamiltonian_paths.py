...
# This file was *autogenerated* from the file hamiltonian_paths.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10); _sage_const_20 = Integer(20); _sage_const_40 = Integer(40)
import numpy as np
...
class RandomHamiltonian(HamPath):
    ...
    If directed is set to false, then the graph is naively forced to be directed. 
    Hence to vertices are connected in both directions with probability higher than q.
...
class HamPathforGnp(HamPath):
    ...
    """
    def __init__(self, n):
        self.p = _sage_const_40 *np.log(n)/n
        if self.p>_sage_const_1 :
            raise ValueError('Value set for n is too small.')
